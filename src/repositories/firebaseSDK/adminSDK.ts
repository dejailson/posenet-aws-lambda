...
export default class AdminSDK {
    ...
    private serviceAccount(){
        return {
            ...
            privateKeyId: process.env.FIRE_PRIVATE_KEY_ID,
            privateKey: process.env.FIRE_PRIVATE_KEY.replace(/\\n/g, '\n'),
            clientEmail: process.env.FIRE_CLIENT_EMAIL,
            clientId: process.env.FIRE_CLIENT_ID,
            authUri: process.env.FIRE_AUTH_URI,
            tokenUri: process.env.FIRE_TOKEN_URI,
            authProviderX509CertUrl: process.env.FIRE_AUTH_PROVIDER_X509_CERT_ERL,
            clientC509CertUrl: process.env.FIRE_CLIENT_X509_CERT_URL,
                    }
        // return {
