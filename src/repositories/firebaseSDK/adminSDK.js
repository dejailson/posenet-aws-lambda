...
export default class AdminSDK {
    ...
    initializeAppAdmin() {
        // console.log(process.env.FIRE_TYPE)
        // console.log(process.env.FIRE_PROJECT_ID)
        // console.log(process.env.FIRE_PRIVATE_KEY_ID)
        // console.log(process.env.FIRE_PRIVATE_KEY.replace(/\\n/g, '\n'))
        // console.log(process.env.FIRE_CLIENT_EMAIL)
        // console.log(process.env.FIRE_AUTH_URI)
        // console.log(process.env.FIRE_TOKEN_URI)
        // console.log(process.env.FIRE_AUTH_PROVIDER_X509_CERT_ERL)
        // console.log(process.env.FIRE_CLIENT_X509_CERT_URL)
